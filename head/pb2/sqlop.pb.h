...
/* @@protoc_insertion_point(class_definition:sql.player_info) */ {
 ...
 public:
  ...
  public:
  // .sql.player_info_kv_int kv_int = 5;
  ...
  public:
  // .sql.player_info_kv_str kv_str = 6;
...
// uint64 guid = 1;
inline void player_info::clear_guid() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.guid_ = ::uint64_t{0u};
}
inline ::uint64_t player_info::guid() const {
  // @@protoc_insertion_point(field_get:sql.player_info.guid)
  return _internal_guid();
}
inline void player_info::set_guid(::uint64_t value) {
  _internal_set_guid(value);
  // @@protoc_insertion_point(field_set:sql.player_info.guid)
}
inline ::uint64_t player_info::_internal_guid() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.guid_;
}
inline void player_info::_internal_set_guid(::uint64_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.guid_ = value;
}
...
inline const std::string& player_info::name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:sql.player_info.name)
  return _internal_name();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void player_info::set_name(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.name_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:sql.player_info.name)
}
inline std::string* player_info::mutable_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:sql.player_info.name)
  return _s;
}
...
inline std::string* player_info::release_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:sql.player_info.name)
  return _impl_.name_.Release();
}
inline void player_info::set_allocated_name(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ...
  // @@protoc_insertion_point(field_set_allocated:sql.player_info.name)
}

// int32 avatar = 3;
inline void player_info::clear_avatar() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.avatar_ = 0;
}
inline ::int32_t player_info::avatar() const {
  // @@protoc_insertion_point(field_get:sql.player_info.avatar)
  return _internal_avatar();
}
inline void player_info::set_avatar(::int32_t value) {
  _internal_set_avatar(value);
  // @@protoc_insertion_point(field_set:sql.player_info.avatar)
}
inline ::int32_t player_info::_internal_avatar() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.avatar_;
}
inline void player_info::_internal_set_avatar(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
